...
public class PredictorTest {
	...
	public void testIdentificarDia1() {
		int resultadoReal=Predictor.identificarDia("29/04/2017");
	...
	public void testIdentificarDia2() {
		int resultadoReal=Predictor.identificarDia("28/04/2017");
		int resultadoEsperado = 7;
		assertEquals(resultadoEsperado, resultadoReal);
	}
	...
	public void testIdentificarUltimoDigito1() {
		int resultadoReal = Predictor.identificarUltimoDigito("AAN-1234");
	...
	public void testIdentificarUltimoDigito2() {
		int resultadoReal = Predictor.identificarUltimoDigito("AAN-123");
	...
	public void testIdentificarUltimoDigito3() {
		int resultadoReal = Predictor.identificarUltimoDigito("AAN-12345");
	...
	public void testValidarHora1() {
		boolean resultadoReal=Predictor.validarHora("08:47:00");
	...
	public void testValidarHora2() {
		boolean resultadoReal=Predictor.validarHora("09:31:00");
		boolean resultadoEsperado=true;
		assertEquals(resultadoEsperado, resultadoReal);
	}
	...
	public void testValidarHora3() {
		boolean resultadoReal=Predictor.validarHora("15:59:59");
		boolean resultadoEsperado=true;
		assertEquals(resultadoEsperado, resultadoReal);
	}
	/**
	...
	public void testValidarHora4() {
		boolean resultadoReal=Predictor.validarHora("18:54:00");
		boolean resultadoEsperado=true;
		assertEquals(resultadoEsperado, resultadoReal);
	}
	...
	public void testPermitirCirculacion1() {
		Boolean resultadoReal=Predictor.permitirCirculacion(6,0,true);
		Boolean resultadoEsperado=true;
		assertEquals(resultadoEsperado, resultadoReal);
	}
	...
	public void testPermitirCirculacion2() {
		Boolean resultadoReal=Predictor.permitirCirculacion(1,0,true);
		Boolean resultadoEsperado=true;
		assertEquals(resultadoEsperado, resultadoReal);
	}
}
